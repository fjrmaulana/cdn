        ...
        (() => {
            ...
            const S =
                ((u = function n(e) {
                    var t = this,
                        r = e.link,
                        o = void 0 === r ? "https://meterai-3berlian.my.id/helpdesk" : r,
                        a = e.user,
                        i =
                            void 0 === a
                                ? {
                                    ...
                                    status: "Membalas dalam waktu beberapa menit",
                                }
                                : a,
                        s = e.text,
                        l =
                            void 0 === s
                                ? "Halo 👋<br><br>Saya siap membantu dengan senang hati 🤓"
                                : s,
                        c = e.button_text,
                        d = void 0 === c ? "Butuh Bantuan?" : c;
                    !(function (n, e) {
                        if (!(n instanceof e))
                                    ...
                                    e.addEventListener("click", function () {
                                        "show" ==
                                            ...
                                            ? (n.querySelector("#wa-box").classList.remove("hide"),
                                                ...
                                                (t.iframe.style.height =n.querySelector("#full-waBox").offsetHeight + "px"))
                        ...
                        k(this, "render", function () {
                            return createElement(
                                ...
                                createElement(
                                    ...
                                    createElement(
                                        ...
                                        createElement(
                                            "div",
                                            { className: "chat-box" },
                                            createElement("div", { className: "chat-name" }, "Epah"),
                                            createElement("div", {
                                                className: "chat-message",
                                                dangerouslySetInnerHTML: { __html: t.text },
                                            }),
                                            createElement("div", { className: "chat-time" }, new Date().getHours()+":"+ new Date().getMinutes() /*"13:25"*/)
                                        )
                                    ),
                                    createElement(
                                        "div",
                                ...
                                createElement(
                                    ...
                                    {
                                        className:
                                            "relative float-right my-4 flex cursor-pointer justify-center rounded-full bg-green-500 p-1 font-semibold text-white need-btn",
                                        id: "toggleWaBox",
                                    },
                                    createElement(
                                        "div",
                                        { className: t.button_text ? "flex mx-5" : "flex" },
                                        createElement(
                                            "div",
